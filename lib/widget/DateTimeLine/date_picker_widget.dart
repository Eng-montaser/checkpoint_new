import 'package:checkpoint/widget/DateTimeLine/tap.dart';
...
class DatePicker extends StatefulWidget {
  ...
  final TextStyle? deactivatedMonthStyle;
  final TextStyle? deactivatedDayStyle;
  DatePicker(
    this.startDate, {
    Key? key,
    this.width = 60,
        ...
        itemBuilder: (context, index) {
          ...
          return DateWidget(
            ...
            monthTextStyle: isDeactivated
                ? widget.deactivatedMonthStyle!
                : isSelected
                    ? widget.selectedMonthStyle!
                    : widget.monthTextStyle,
            dateTextStyle: isDeactivated
                ? widget.deactivatedDateStyle!
                : isSelected
                    ? widget.selectedDateStyle!
                    : widget.dateTextStyle,
            dayTextStyle: isDeactivated
                ? widget.deactivatedDayStyle!
                : isSelected
