...
typedef WidgetAction = void Function(String path, bool status);

/// Example app.
class SimpleRecorder extends StatefulWidget {
  final WidgetAction widgetAction;

  const SimpleRecorder({super.key, required this.widgetAction});
  @override
...
class _SimpleRecorderState extends State<SimpleRecorder> {
  ...
  Future<void> openTheRecorder() async {
    ...
    _mPath = '${tempDir.path}/checkpoint_sound${ext[_codec.index]}';
